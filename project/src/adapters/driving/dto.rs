...
impl From<crate::domain::models::db::project_rows::ProjectRow> for ProjectResponse {
    fn from(row: crate::domain::models::db::project_rows::ProjectRow) -> Self {
        Self {
            id: row.pk_project,
            name: row.tx_name,
...
impl From<crate::domain::models::db::project_rows::ProjectStageRow> for StageResponse {
    fn from(row: crate::domain::models::db::project_rows::ProjectStageRow) -> Self {
        Self {
...
impl From<crate::domain::models::db::project_rows::ProjectDailyAllocationRow>
    for AllocationResponse
{
    fn from(row: crate::domain::models::db::project_rows::ProjectDailyAllocationRow) -> Self {
        Self {
