...
CREATE INDEX idx_tb_client_contact_fk_client ON "clients"."tb_client_contact" ("fk_client");
CREATE INDEX idx_tb_client_contact_fk_contact ON "clients"."tb_client_contact" ("fk_contact");
...
CREATE INDEX idx_tb_allocated_collaborator_fk_project ON "clients"."tb_allocated_collaborator" ("fk_project");
CREATE INDEX idx_tb_allocated_collaborator_fk_collaborator ON "clients"."tb_allocated_collaborator" ("fk_collaborator");
