...
use milions_sys::adapters::driven::pg_client_repository::PgClientRepository;
use milions_sys::application::client_service::ConcreteClientService;
use milions_sys::domain::ports::client_repository::CreateClient;
use milions_sys::domain::ports::client_use_cases::{
...
async fn list_clients_returns_all(pool: PgPool) {
    ...
    repo.create(milions_sys::domain::models::db::client_row::CreateClientRow {
...
async fn update_client_changes_name(pool: PgPool) {
    ...
    let created = repo
        .create(milions_sys::domain::models::db::client_row::CreateClientRow {
...
async fn find_by_document_returns_none_for_missing(pool: PgPool) {
    ...
    let result = milions_sys::domain::ports::client_use_cases::FindClientByDocumentUseCase::execute(
        &service,
        "11144477735",
    )
    .await
